...
<head>
    ...
    <script type="text/javascript" src="<?php echo $this->project_name;?>/page/homepage/js/news.js<?php echo $version;?>"></script>
        ...
        <div class="sub-banner-tab">
          <div class="bd-lg dis-f align-i-c bg-w">
            ...
            <ul class="dis-f">
              ...
              <li><a class="lang_on" href="?param=cp_news"><i>News.</i></a></li>
            ...
            <div class="bd-lg">
                <div class="inner">
                      <div class="main_title">
                          ...
                          <b class="wow fadeInUp" data-wow-delay="0.3s">News</b>
                      </div>
                      <div class="news_con">
                        <ul class="row" data-wrap="wrap" id="wrap">
                          <!-- <li class="col-md-4 col-xs-6">
                            <div class="con_wrap" onClick="location.href='?param=cp_news_view'">
                              <div class="img_wrap"><img src="UVC/page/homepage/img/sub/news_thum.png" alt="뉴스 썸네일 예시"/></div>
                              <div class="txt_wrap">
                                <b>News</b>
                                <p>홈페이지가 리뉴얼되었습니다. 많은 관은 관심과 사랑 감사합니다.</p>
                                <span>23.01.18</span>
                              </div>
                            </div>
                          </li>
