...
<head>
    ...
    <script type="text/javascript" src="<?php echo $this->project_name;?>/page/homepage/js/ref_view.js<?php echo $version;?>"></script>
    ...
    <div class="wrap" style="overflow:inherit;">        
        ...
        <div class="sub-banner-tab">
          <div class="bd-lg dis-f align-i-c bg-w">
            <h3>REFERENCE</h3>
            <ul class="dis-f">
              <li><a href="?param=cp_info"><i>Reference</i></a></li>
            </ul>
          </div>
        </div>
        <div class="sub-body">
                ...
                <div class="inner">
                      ...
                      <div class="news_view_con">
                        ...
                        <div class="news_list_btn">
                            <span><a href="?param=ref">LIST</a></span> 
                        </div>
                    </div>
                 </div>
            </div>
