...
function set_lang(lang){
    ...
    if(obj.elem.current_lang != null){
        if(lang == 1){
            document.getElementById('current_lang').querySelectorAll('a')[0].classList.add('lang_on');
            document.getElementById('current_lang').querySelectorAll('a')[1].classList.remove('lang_on');
            document.querySelector('html').setAttribute('lang', "ko");
       

        }else if(lang == 2){
            document.getElementById('current_lang').querySelectorAll('a')[1].classList.add('lang_on');
            document.getElementById('current_lang').querySelectorAll('a')[0].classList.remove('lang_on');
