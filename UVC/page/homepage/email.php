...
<head>
    ...
    <script type="text/javascript" src="<?php echo $this->project_name;?>/page/homepage/js/email.js<?php echo $version;?>"></script>
          ...
          <div class="inner">
             <div class="bd-lg">
              <div class="policy_con">
                    <h3><?php echo $this->utillLangController->lang("ser06","이메일무단수집거부");?></h3>
