...
<head>
	...
	<script type="text/javascript" src="<?php echo $this->project_name;?>/page/adm/js/adm_certify_modify.js<?php echo $version;?>"></script>
		...
		<section class="adm_container bg-pale">
			<div class="adm_body_wrap">
				<div class="adm_common_header mb-5">
					<h2 class="page-title pb-1">인증서</h2>
						...
						<div class="row-short">
							...
							<div class="col-md-11">
								<div class="post-box">
									...
									<dl class="post-table" id="category_wrap">
												<dt>카테고리</dt>
												<dd>
													<div class="insert">
														<select id="category" class="select">
															<option value="0">선택</option>
															<option value="1">디지털 트윈 / XR 원천기술 보유</option>
															<option value="2">OPC UA 국제표준기술 국내 최초 사용화</option>
															<!-- <option value="4">인증서</option> -->
