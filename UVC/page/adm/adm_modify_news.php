...
<head>
	...
	<script type="text/javascript" src="<?php echo $this->project_name;?>/page/adm/js/adm_news_modify.js<?php echo $version;?>"></script>
...
<body>
	...
	<div class="wrap">
		...
		<section class="adm_container bg-pale">
			<div class="adm_body_wrap">
				<div class="adm_common_header mb-5">
					<h2 class="page-title pb-1">뉴스 수정</h2>
					...
					<form  class="form_section" id="form"  onsubmit="return false;">
						...
						<!-- 파트를 나눌때 row col 사용 // -->
							<div class="row-short">
								...
								<div class="col-md-12">
									<div class="post-box">
										<!-- <h5 class="post-title">홍보영상 수정</h5> -->
									...
									<div class="button save-btn right_button mt-3">
										<button type="button" class="center_button btn-primary" onclick="register_news();">저장하기</button>
		...
		<div style="display: none;">
			...
			<div data-copy="copy">
				...
				<dl class="post-table" data-attr="file_dl">
					<dt>첨부파일</dt>
					<dd>
						<div class="insert file-insert" data-attr="file_wrap" data-wrap="file_input_wrap">
							<div class="input-box">
	...
	<div style="display: none;">
		<div class="input-box" data-copy="file_input_copy" id="file_copy" data-file>
			<input placeholder="파일첨부" class="file_name input-sm" disabled="" data-attr="file_name" data-file-name>
			<input type="file" class="blind" data-attr="file" onchange="add_file(this);" data-file-input>
			<label class="file_add_btn text-center theme-bor-primary" data-attr="file_label" data-file-label for="file">파일추가</label>
			<span class="del-btn" data-attr="del_file_btn" data-file-del></span>
		</div>
	</div>
</body>
</html>