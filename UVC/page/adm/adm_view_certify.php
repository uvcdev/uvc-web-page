...
<head>
	...
	<script type="text/javascript" src="<?php echo $this->project_name;?>/page/adm/js/adm_certify_view.js<?php echo $version;?>"></script>
		...
		<section class="adm_container bg-pale">
			<div class="adm_body_wrap">
				...
				<div class="button save-btn left_button mt-3">
					<button class="center_button btn-primary" onclick="move_page('upload_certify');">등록하기</button>
	...
	<div style="display: none;">
		<table>
			<tr data-copy="copy">
				...
				<td><em data-attr="category"></em></td>
				<td>
					<div class="thumb-nail">
