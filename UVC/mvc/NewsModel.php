<?php
    class NewsModel extends gf{
        ...
        *********************************************************************/
        ...
        /********************************************************************* 
        // 함 수 : main news Select
        // 만든이: 박여진
        // 담당자: 
        *********************************************************************/
        function main_news_select() {
            $param = $this->json;

            $query = "SELECT * FROM news where lang_idx = ".$param["lang_idx"];
        ...
        *********************************************************************/
        ...
        function news_select1() {
            $param = $this->json;
            // if($this->value_check(array("page_size", "move_page"))){
            
              
                $query = "SELECT * FROM news WHERE lang_idx = ".$param["lang_idx"]." ORDER BY date asc";
                $result = $this->conn->db_select($query);
        ...
        *********************************************************************/
        function detail_news() {
            ...
            $query = "SELECT * FROM news WHERE idx = ".$this->null_check($param["idx"])." and lang_idx = ".$param["lang_idx"];
            $result = $this->conn->db_select($query);
            
            if($result["result"] == "1"){
                $this->result = $result;
                $query = "SELECT * FROM news_file WHERE key_code = ".$this->null_check($result["value"][0]["key_code"])." and lang_idx = ".$param["lang_idx"];
        ...
        *********************************************************************/
        function neighbor_post() {
            ...
            $query = "SELECT idx, title FROM news ";
