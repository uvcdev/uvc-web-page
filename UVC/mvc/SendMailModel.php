        ...
        *********************************************************************/
		function send_mail() {
            ...
            if($this->value_check(array( "name", "phone", "email", "content"))) {
                $query = "INSERT INTO inquiry(name, count, contact, date, email, content, phone, lang_idx, reg_date) VALUES(";
                
                $query = $query.$this->null_check($param["name"]).",";
                $query = $query.$this->null_check($param["count"]).",";
                $query = $query.$this->null_check($param["contact"]).",";
                ...
                if($result["result"] == "1") {
                    ...
                    // if($param["category"] != "0") {
                        ...
                        $json["title"] = "고객문의가 도착했습니다."; //이메일 제목 ( 이메일 제목 바꾸기 )
                        $json["to_list"] = ["sales@uvc.co.kr"]; //메일 받을사람 주소 array    
                    ...
                    <div class="boundary"style="max-width:900px; padding:24px; margin:0 auto;">						   
                        ...
                        <div class="content"style="border:1px solid #ddd; padding:40px 0;">
                            <div class="logo"style="padding-bottom:20px; margin:0 auto;">
                                <img src="https://s3.ap-northeast-2.amazonaws.com/lbplatform/images/SMALLLAB/16406716218834.png" style="width:148px; " alt="logo">
                            </div>
                            ...
                            <div class="content-box" style="width:80%; overflow:hidden; border:1px solid #ddd; margin:0 auto; margin-top:15px; padding:20px;">
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        <td style="height:40px; font-size:15px; border:3px solid #fff; box-sizing:border-box;  width:100px; text-align:center; background-color:#ddd">인원수</td>
                                        <td style="height:40px; font-size:15px;  border:3px solid #fff; box-sizing:border-box; text-align:left;">'.$param["count"].'</td>
                                    </tr>
                                    <tr>
                                        <td style="height:40px; font-size:15px; border:3px solid #fff; box-sizing:border-box;  width:100px; text-align:center; background-color:#ddd">신청날짜</td>
                                        <td style="height:40px; font-size:15px;  border:3px solid #fff; box-sizing:border-box; text-align:left;">'.$param["date"].'</td>
                                    </tr>
                                    <tr>
                                        <td style="height:40px; font-size:15px; border:3px solid #fff; box-sizing:border-box;  width:100px; text-align:center; background-color:#ddd">유선전화</td>
                                        <td style="height:40px; font-size:15px;  border:3px solid #fff; box-sizing:border-box; text-align:left;">'.$param["contact"].'</td>
                                    </tr>
                                    <tr>
                                        <td style="height:40px; font-size:15px; border:3px solid #fff; box-sizing:border-box;  width:100px; text-align:center; background-color:#ddd">휴대전화</td>
